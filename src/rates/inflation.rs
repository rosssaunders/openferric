//! Module `rates::inflation`.
//!
//! Implements inflation abstractions and re-exports used by adjacent pricing/model modules.
//!
//! References: Hull (11th ed.) Ch. 4, 6, and 7; Brigo and Mercurio (2006), curve and accrual identities around Eq. (4.2) and Eq. (7.1).
//!
//! Key types and purpose: `InflationCurve`, `InflationCurveBuilder`, `ZeroCouponInflationSwap`, `YearOnYearInflationSwap`, `InflationIndexedBond` define the core data contracts for this module.
//!
