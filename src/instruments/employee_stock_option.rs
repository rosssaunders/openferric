...
mod tests {
    ...
    #[test]
    fn maturity_vested_eso_matches_independent_crr_grid() {
        // Vesting at maturity removes early exercise; zero attrition and zero
        // grants remove ESO-specific scaling. The fixed 800-step reference was
        // generated by an independent SciPy/Python CRR backward recurrence.
        ...
        let price = eso.price_binomial(100.0, 0.03, 0.01, 0.25, 800).unwrap();
        assert_relative_eq!(price, 15.486_896_000_941_87, epsilon = 2.0e-10);
    }
