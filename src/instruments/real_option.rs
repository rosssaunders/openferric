//! Module `instruments::real_option`.
//!
//! Implements real option abstractions and re-exports used by adjacent pricing/model modules.
//!
//! References: Hull (11th ed.) for market conventions and payoff identities, with module-specific equations referenced by the concrete engines and models imported here.
//!
//! Key types and purpose: `DiscreteCashFlow`, `RealOptionBinomialSpec`, `DeferInvestmentOption`, `ExpandOption`, `AbandonmentOption` define the core data contracts for this module.
//!
