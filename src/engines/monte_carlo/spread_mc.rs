//! Module `engines::monte_carlo::spread_mc`.
//!
//! Implements spread mc abstractions and re-exports used by adjacent pricing/model modules.
//!
//! References: Glasserman (2004), Longstaff and Schwartz (2001), Hull (11th ed.) Ch. 25, Monte Carlo estimators around Eq. (25.1).
//!
//! Key types and purpose: `SpreadMonteCarloEngine` define the core data contracts for this module.
//!
