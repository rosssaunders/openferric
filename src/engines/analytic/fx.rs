...
//!
//! Key types and purpose: `FxGreeks`, `GarmanKohlhagenEngine` define the core data contracts for this module.
//!
...
mod tests {
    ...
    fn eurusd_call_matches_reference() {
        ...
        assert_relative_eq!(price, 0.019_953_800_723_103_543, epsilon = 2e-14);
    }
