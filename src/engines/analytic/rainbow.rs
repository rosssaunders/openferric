//! Module `engines::analytic::rainbow`.
//!
//! Implements rainbow workflows with concrete routines such as `best_of_two_call_price`, `worst_of_two_call_price`, `two_asset_correlation_price`.
//!
...
//!
//! Key types and purpose: `RainbowAnalyticEngine` define the core data contracts for this module.
//!
