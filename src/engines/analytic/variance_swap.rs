//! Module `engines::analytic::variance_swap`.
//!
//! Implements variance swap workflows with concrete routines such as `fair_variance_strike_from_quotes`, `fair_volatility_strike_from_variance`, `variance_swap_mtm`, `volatility_swap_mtm`.
//!
...
//!
//! Key types and purpose: `VarianceSwapEngine` define the core data contracts for this module.
//!
