//! Module `engines::tree::two_asset_tree`.
//!
//! Implements two asset tree abstractions and re-exports used by adjacent pricing/model modules.
//!
//! References: Hull (11th ed.) Ch. 13, Cox-Ross-Rubinstein (1979), and backward-induction recursions around Eq. (13.10).
//!
//! Key types and purpose: `TwoAssetBinomialEngine` define the core data contracts for this module.
//!
