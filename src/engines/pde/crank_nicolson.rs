...
/// Uses reciprocal multiplication instead of division in the forward sweep,
/// and splits the last element to eliminate per-iteration branch.
fn solve_tridiagonal_inplace(
    ...
    // Forward sweep for interior elements (no branch on last element).
