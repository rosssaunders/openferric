...
fn margrabe_case(t: f64, vol2: f64, rho: f64, expected: f64) {
...
fn stulz_best_of_two_rho090() {
    best_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.90, 1.0, 17.565);
}

#[test]
fn stulz_best_of_two_rho070() {
    best_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.70, 1.0, 19.980);
}

#[test]
fn stulz_best_of_two_rho050() {
    best_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.50, 1.0, 21.619);
}

#[test]
fn stulz_best_of_two_rho030() {
    best_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.30, 1.0, 22.932);
}

#[test]
fn stulz_best_of_two_rho010() {
    best_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.10, 1.0, 24.049);
}

#[test]
fn stulz_best_of_two_s1_80_s2_100() {
    best_of_two_case(80.0, 100.0, 100.0, 0.30, 0.30, 0.30, 1.0, 16.508);
}

#[test]
fn stulz_best_of_two_s1_80_s2_80() {
    best_of_two_case(80.0, 80.0, 100.0, 0.30, 0.30, 0.30, 1.0, 8.049);
}

#[test]
fn stulz_best_of_two_s1_80_s2_120() {
    best_of_two_case(80.0, 120.0, 100.0, 0.30, 0.30, 0.30, 1.0, 30.141);
}

#[test]
fn stulz_best_of_two_s1_120_s2_120() {
    best_of_two_case(120.0, 120.0, 100.0, 0.30, 0.30, 0.30, 1.0, 42.889);
}
...
fn stulz_worst_of_two_rho090() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.90, 1.0, 10.898);
}

#[test]
fn stulz_worst_of_two_rho070() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.70, 1.0, 8.483);
}

#[test]
fn stulz_worst_of_two_rho050() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.50, 1.0, 6.844);
}

#[test]
fn stulz_worst_of_two_rho030() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.30, 1.0, 5.531);
}

#[test]
fn stulz_worst_of_two_rho010() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.30, 0.30, 0.10, 1.0, 4.413);
}

#[test]
fn stulz_worst_of_two_asymmetric_vols() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.50, 0.70, 0.00, 1.0, 4.981);
}

#[test]
fn stulz_worst_of_two_vol1_050_vol2_030() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.50, 0.30, 0.00, 1.0, 4.159);
}

#[test]
fn stulz_worst_of_two_vol1_050_vol2_010() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.50, 0.10, 0.00, 1.0, 2.597);
}

#[test]
fn stulz_worst_of_two_vol1_050_vol2_010_rho050() {
    worst_of_two_case(100.0, 100.0, 100.0, 0.50, 0.10, 0.50, 1.0, 4.030);
}
...
fn haug_dividend_best_of_two(q1: f64, q2: f64, expected: f64) {
    let option = BestOfTwoCallOption {
        s1: 100.0,
        s2: 105.0,
        k: 98.0,
...
fn haug_best_of_two_no_dividends() {
    haug_dividend_best_of_two(0.0, 0.0, 11.6323);
}

#[test]
fn haug_best_of_two_with_dividends() {
    haug_dividend_best_of_two(0.06, 0.09, 8.0701);
}

fn haug_dividend_worst_of_two(q1: f64, q2: f64, expected: f64) {
    let option = WorstOfTwoCallOption {
        s1: 100.0,
        s2: 105.0,
        k: 98.0,
...
fn haug_worst_of_two_no_dividends() {
    haug_dividend_worst_of_two(0.0, 0.0, 4.8177);
}

#[test]
fn haug_worst_of_two_with_dividends() {
    haug_dividend_worst_of_two(0.06, 0.09, 2.9340);
}
...
fn kirk_case(t: f64, vol1: f64, vol2: f64, rho: f64, expected: f64) {
...
fn kirk_haug_t010_v020_v020_rho_neg050() {
    kirk_case(0.10, 0.20, 0.20, -0.50, 4.7530);
}

#[test]
fn kirk_haug_t010_v020_v020_rho_000() {
    kirk_case(0.10, 0.20, 0.20, 0.00, 3.7970);
}

#[test]
fn kirk_haug_t010_v020_v020_rho_050() {
    kirk_case(0.10, 0.20, 0.20, 0.50, 2.5537);
}

#[test]
fn kirk_haug_t010_v025_v020_rho_neg050() {
    kirk_case(0.10, 0.25, 0.20, -0.50, 5.4275);
}

#[test]
fn kirk_haug_t010_v025_v020_rho_000() {
    kirk_case(0.10, 0.25, 0.20, 0.00, 4.3712);
}

#[test]
fn kirk_haug_t010_v025_v020_rho_050() {
    kirk_case(0.10, 0.25, 0.20, 0.50, 3.0086);
}

#[test]
fn kirk_haug_t010_v020_v025_rho_neg050() {
    kirk_case(0.10, 0.20, 0.25, -0.50, 5.4061);
}

#[test]
fn kirk_haug_t010_v020_v025_rho_000() {
    kirk_case(0.10, 0.20, 0.25, 0.00, 4.3451);
}

#[test]
fn kirk_haug_t010_v020_v025_rho_050() {
    kirk_case(0.10, 0.20, 0.25, 0.50, 2.9723);
}

#[test]
fn kirk_haug_t050_v020_v020_rho_neg050() {
    kirk_case(0.50, 0.20, 0.20, -0.50, 10.7517);
}

#[test]
fn kirk_haug_t050_v020_v020_rho_000() {
    kirk_case(0.50, 0.20, 0.20, 0.00, 8.7020);
}

#[test]
fn kirk_haug_t050_v020_v020_rho_050() {
    kirk_case(0.50, 0.20, 0.20, 0.50, 6.0257);
}

#[test]
fn kirk_haug_t050_v025_v020_rho_neg050() {
    kirk_case(0.50, 0.25, 0.20, -0.50, 12.1941);
}

#[test]
fn kirk_haug_t050_v025_v020_rho_000() {
    kirk_case(0.50, 0.25, 0.20, 0.00, 9.9340);
}

#[test]
fn kirk_haug_t050_v025_v020_rho_050() {
    kirk_case(0.50, 0.25, 0.20, 0.50, 7.0067);
}

#[test]
fn kirk_haug_t050_v020_v025_rho_neg050() {
    kirk_case(0.50, 0.20, 0.25, -0.50, 12.1483);
}

#[test]
fn kirk_haug_t050_v020_v025_rho_000() {
    kirk_case(0.50, 0.20, 0.25, 0.00, 9.8780);
}

#[test]
fn kirk_haug_t050_v020_v025_rho_050() {
    kirk_case(0.50, 0.20, 0.25, 0.50, 6.9284);
}
